...
define('DB_DATABASE', 'login_and_reg'); //make sure to set your database
...
function fetch_all($query)
{
	...
	while($row = mysqli_fetch_assoc($result)) // mysqli_fetch_assoc() is a built in function that converts a result to an associative array.
	{
		$data[] = $row;
	}
	return $data;
...
{
	global $connection;  //put global to access variables outside of our function's scope
	$result = $connection->query($query);
